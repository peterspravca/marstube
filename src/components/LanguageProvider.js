...
const translations = {
  sk: {
    ...
    "player.checkingStatus": "Kontrolujem stav súboru na serveri...",
    "player.preparingDownload": "Pripravujem prehrávanie (sťahujem súbor na server, zvyčajne to trvá 2-5 sekúnd)...",
  ...
  en: {
    ...
    "player.next": "Next",
    "player.checkingStatus": "Checking file status on server...",
    "player.preparingDownload": "Preparing playback (downloading file to server, usually takes 2-5 seconds)...",
